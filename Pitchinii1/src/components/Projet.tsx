  ...
  const Projet: FunctionComponent<FrameComponentProps> = ({ activeTab, projectWork, userId }) => {
    ...
    { showPopup && (   <div className="pop"> <div className="self-stretch flex-1 flex flex-col items-start justify-start relative gap-[8.3px] max-w-full">
            ...
            <div className="self-stretch flex flex-col items-start justify-start gap-[48.2px] max-w-full">
              <div className="self-stretch flex flex-col items-start justify-start gap-[24.9px] max-w-full text-mini-9">
                ...
                <div className="self-stretch flex flex-col items-start justify-start gap-[5px] shrink-0 text-sm-3">
                  <div className="w-[181.8px] relative tracking-[-0.01em] leading-[22.4px] font-medium flex items-center textcolor-blue">Description project </div>
          ...
          <div className="flis">
            ...
            <button   onClick={onSaveClick} className="cursor-pointer [border:none] p-0 bg-[transparent] w-[142px] !m-[0]   flex flex-row items-start justify-start z-[2]">
