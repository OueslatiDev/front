import {
  ...
  import { Button, MenuItem, Select, SelectChangeEvent, Table, TableBody, TableCell, TableContainer, TableHead, TableRow } from "@mui/material";
          ...
          try {
            ...
            if (projectId) {
              ...
              await send(
                ...
                fileFormData,
                navigating,
                "http://localhost:3001/api/fichier"
              );
              ...
              for (const value of domainServicesPrices) {
                if (services.includes(value.service)) {
                  ...
                  await send(
                    ...
                    navigating,
                    "http://localhost:3001/api/projectsServicessList"
                  );
                }
              }
            } else {
